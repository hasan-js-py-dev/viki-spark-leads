...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    services: [
      { id: 'b2b-leads', name: 'B2B Targeted Leads', description: 'Custom B2B contact lists matched to your ICP with verified emails & direct dials', credits: 150, popular: true },
      { id: 'ecommerce-leads', name: 'eCommerce Leads', description: 'Targeted eCommerce store owners and decision makers', credits: 180 },
      { id: 'intent-leads', name: 'Intent-Based Leads', description: 'Contacts showing buying intent signals for your product/service', credits: 250, popular: true },
      { id: 'event-leads', name: 'Event & Webinar Attendees', description: 'Leads from industry conferences, webinars, and trade shows', credits: 200 },
      { id: 'hiring-signals', name: 'Hiring Signal Leads', description: 'Companies actively hiring for roles related to your solution', credits: 180 },
      { id: 'funding-leads', name: 'Recently Funded Companies', description: 'Startups and companies that recently raised funding', credits: 220 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'linkedin-enrichment', name: 'LinkedIn URL Enrichment', description: 'Add comprehensive LinkedIn profile data to your contacts', credits: 80, popular: true },
      { id: 'email-enrichment', name: 'Email Enrichment', description: 'Find and verify business email addresses for your contacts', credits: 60 },
      { id: 'phone-enrichment', name: 'Phone Number Enrichment', description: 'Add verified direct dials and mobile numbers', credits: 100, popular: true },
      { id: 'personal-phone', name: 'Personal Phone Enrichment', description: 'Find personal mobile numbers for hard-to-reach prospects', credits: 150 },
      { id: 'company-enrichment', name: 'Company Data Enrichment', description: 'Add firmographics, technographics, and company insights', credits: 70 },
      { id: 'catchall-validation', name: 'Catch-All Email Validation', description: 'Validate risky catch-all emails before sending', credits: 40 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'linkedin-sales-nav', name: 'LinkedIn Sales Navigator Scraping', description: 'Extract leads from your Sales Nav searches with emails', credits: 120, popular: true },
      { id: 'linkedin-email', name: 'LinkedIn Email Scraping', description: 'Find verified emails for LinkedIn profiles', credits: 80 },
      { id: 'apollo-scraping', name: 'Apollo Leads Scraping', description: 'Extract contacts from Apollo.io searches', credits: 100 },
      { id: 'zoominfo-scraping', name: 'ZoomInfo Scraping', description: 'Access ZoomInfo contact data without subscription', credits: 150, popular: true },
      { id: 'lusha-scraping', name: 'Lusha Scraping', description: 'Extract Lusha contact and company data', credits: 120 },
      { id: 'clay-scraping', name: 'Clay Scraping', description: 'Get Clay enrichment data at scale', credits: 130 },
      { id: 'lemlist-scraping', name: 'Lemlist Scraping', description: 'Extract leads from Lemlist campaigns', credits: 90 },
      { id: 'cognism-scraping', name: 'Cognism Data Access', description: 'European B2B contacts from Cognism', credits: 140 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'google-maps', name: 'Google Maps Scraping', description: 'Local businesses with contact info, reviews, and details', credits: 60, popular: true },
      { id: 'directory-scraping', name: 'Directories Scraping', description: 'Extract from industry directories and business listings', credits: 70 },
      { id: 'facebook-scraping', name: 'Facebook Scraping', description: 'Business pages, groups, and event attendees', credits: 90 },
      { id: 'twitter-scraping', name: 'Twitter/X Scraping', description: 'Followers, following, and engagement data', credits: 80 },
      { id: 'instagram-scraping', name: 'Instagram Scraping', description: 'Business profiles and follower data', credits: 85 },
      { id: 'reddit-scraping', name: 'Reddit Scraping', description: 'Community members and discussion participants', credits: 75 },
      { id: 'custom-scraping', name: 'Custom Website Scraping', description: 'Any website or platform with structured data', credits: 100 },
      { id: 'review-scraping', name: 'Review Sites Scraping', description: 'G2, Capterra, TrustPilot reviewer data', credits: 110 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'manual-research', name: 'Manual Prospect Research Team', description: 'Dedicated researchers for your account', credits: 500, popular: true },
      { id: 'executive-research', name: 'C-Suite & Executive Research', description: 'Hard-to-find executive contact information', credits: 300 },
      { id: 'account-mapping', name: 'Account Mapping', description: 'Complete org charts and decision maker identification', credits: 250 },
      { id: 'icp-research', name: 'ICP Development Research', description: 'Research to define and refine your ideal customer profile', credits: 400 },
      { id: 'competitor-intel', name: 'Competitor Intelligence', description: 'Deep research on competitor customers and strategies', credits: 350 },
      { id: 'market-research', name: 'Market Research', description: 'Industry analysis and market sizing research', credits: 450 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'email-setup', name: 'Cold Email Mailbox Setup', description: 'Complete technical setup with SPF/DKIM/DMARC and warm-up', credits: 200 },
      { id: 'combo-small', name: 'Combo Pack - Small Agency', description: '3 email setups + 10,000 leads/month', credits: 800, popular: true },
      { id: 'combo-medium', name: 'Combo Pack - Medium', description: '5 email setups + 30,000 leads/month', credits: 1500 },
      { id: 'combo-large', name: 'Combo Pack - Large', description: '10 email setups + 50,000 leads/month', credits: 2500, popular: true },
      { id: 'combo-enterprise', name: 'Combo Pack - Enterprise', description: '20 email setups + 100,000 leads/month', credits: 4500 },
      { id: 'managed-email', name: 'Managed Cold Email Campaigns', description: 'Full campaign management with copywriting', credits: 600 },
      { id: 'linkedin-outreach', name: 'LinkedIn Outreach Management', description: 'Done-for-you LinkedIn campaigns', credits: 450 },
      { id: 'multichannel', name: 'Multi-Channel Outreach', description: 'Coordinated email + LinkedIn + phone campaigns', credits: 900 },
    ],
    benefits: [
  ...
  },
  {
    ...
    services: [
      { id: 'ai-sdr', name: 'AI SDR Agent', description: 'AI that prospects, qualifies, and books meetings 24/7', credits: 800, popular: true },
      { id: 'ai-email', name: 'AI Email Responder', description: 'Intelligent email response handling and qualification', credits: 500 },
      { id: 'ai-linkedin', name: 'AI LinkedIn Agent', description: 'Automated LinkedIn engagement and conversation handling', credits: 550 },
      { id: 'ai-chat', name: 'AI Chat Agent', description: 'Website chatbot for lead capture and qualification', credits: 400 },
      { id: 'ai-research', name: 'AI Research Assistant', description: 'Automated prospect research and insights', credits: 350 },
      { id: 'custom-ai', name: 'Custom AI Agent Development', description: 'Fully customized AI solution for your workflow', credits: 1200 },
    ],
    benefits: [
